...
使用开源工具进行 Linux 内存取证 [[1]](https://linux.cn/article-13425-1.html)

Perform Linux memory forensics with this open source tool [[2]](https://opensource.com/article/21/4/linux-memory-forensics)
