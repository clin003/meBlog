...
当你学习 GNU Screen 的使用方法时，需要记住很多新的键盘命令。有些命令你马上就能记住，但那些你不常使用的命令可能就很难记住了。你可以按 `Ctrl+A` 然后再按 `?` 来访问 GNU Screen 的帮助界面。

学习 GNU Screen 是提高你使用你最喜欢的 终端模拟器 的效率和敏捷性的一个好方法。请试一试吧！

### 参考

Linux tips for using GNU Screen [[1]](https://opensource.com/article/21/4/gnu-screen-cheat-sheet)

使用 GNU Screen 的小技巧    [[2]](https://linux.cn/article-13387-1.html)
